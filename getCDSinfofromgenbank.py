...
# What it does
#     it searches the 'features' in a GenBank file for the 'CDS' feature.
#     Once a 'CDS' feature is found, it looks for the required information
#     It also looks for the CDS location and gets the actual gene from the whole
...
if len(sys.argv) != 3:
    print "Usage: getCDSinfofromgenbank.py <inputfile> <outputfile>"
    quit()
...
# print the start
print "Getting the CDS information and appending to the outputfile..."
